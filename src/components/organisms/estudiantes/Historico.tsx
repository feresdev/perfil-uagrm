...
interface ComponentsProps {
    estado: { data: HistoricoMain | null, error: ErrorResponse | null , loading: boolean };
}

export default function HistoricoSection({ estado: { data, error, loading } }: ComponentsProps) {
    return (
        <div>
                                            ...
                                            <table className="table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th className="py-3 px-4 text-left table-cell">CARRERA</th>
                                                        <th className="py-3 px-4 text-left table-cell">MATERIA</th>
                                                        <th className="py-3 px-4 text-left">CR</th>
                                                        ...
                                                        <tr key={index + 1} className="relative hover:bg-dark-border-color transition-colors">
                                                            ...
                                                            <td className="whitespace-nowrap">
                                                                <div className="flex items-center gap-2">
                                                                    <span className="text-td capitalize">{materia.carrera}</span>
                                                                </div>
                                                            </td>
                                                            <td className="whitespace-nowrap">
                                                                <div className="flex items-center gap-2">
                                                            ...
                                                            <td className="whitespace-nowrap">
                                                                <div className="flex items-center gap-2">
                                                                    <span className="text-td capitalize">{materia.cr}</span>
                                                                </div>
                                                            </td>
                                                            <td className="whitespace-nowrap">
                                                                <div className="flex items-center gap-2">
